(function ($) {
  ...
  $(".projects-masonary-wrapper").imagesLoaded(function () {
    ...
    $(".messonry-button").on("click", "button", function (e) {
      e.preventDefault();
  ...
  $(document).ready(function () {
    ...
    var whyChooseSolutionsSlider = new Swiper(".why-choose-solutions", {
      // Default settings for large screens (desktop)
      slidesPerView: 4, // Show 4 boxes on desktop
      slidesPerGroup: 4,
      loop: false, // Disable looping on desktop (no carousel)
      speed: 1000,
      ...
      breakpoints: {
        // For large screens (≥ 1499px), no carousel (static layout)
        1499: {
          slidesPerView: 4,
          slidesPerGroup: 4,
          loop: false,
        ...
        // For medium-sized screens (≥ 991px), no carousel
        991: {
          slidesPerView: 2,
          slidesPerGroup: 2,
          loop: false,
        ...
        // For small screens (≥ 767px), carousel is enabled
        767: {
          slidesPerView: 1,
          slidesPerGroup: 1,
          loop: true,
        ...
        // For extra-small screens (≥ 575px), carousel is enabled
        575: {
          slidesPerView: 1,
          slidesPerGroup: 1,
          loop: true,
    ...
    var funFactSlider = new Swiper(".fun-fact-wrapper .swiper-container", {
      // Default settings for large screens (desktop)
      slidesPerView: 5, // Show 5 slides on large screens
      slidesPerGroup: 5,
      loop: false, // Disable looping on desktop (no need for autoplay)
      speed: 1000,
      spaceBetween: 30,
      autoplay: false, // Disable autoplay for desktop
      navigation: {
      ...
      breakpoints: {
        // For large screens (≥ 1499px), no carousel (scroll disabled)
        1499: {
          slidesPerView: 5,
          slidesPerGroup: 5,
          loop: false, // No loop on large screens
          autoplay: false, // Disable autoplay for desktop
        },
        // For medium-sized screens (≥ 991px), no carousel (scroll disabled)
        991: {
          slidesPerView: 5,
          slidesPerGroup: 5,
          loop: false, // No loop on medium screens
          autoplay: false, // Disable autoplay for medium screens
        },
        // For smaller screens (≥ 767px), carousel is enabled
        767: {
          slidesPerView: 1,
          slidesPerGroup: 1,
          loop: true, // Enable loop for responsive view
          autoplay: {
            delay: 3000, // Autoplay for responsive view
          },
        },
        // For extra-small screens (≥ 575px), carousel is enabled
        575: {
          slidesPerView: 1,
          slidesPerGroup: 1,
          loopAdditionalSlides: 1, // Add extra slides for smooth looping
          loop: true, // Enable loop for mobile view
          autoplay: {
            delay: 3000, // Autoplay for smaller mobile view
          },
        },
      },
    });
  ...
  $(document).on("click", function (e) {
    // Check if the click is outside the demoOption container and not the button
    if (!$(e.target).closest(".demo-option-container, .quick-option").length) {
      $demoOption.removeClass("open");
    }
  });
